    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow">
        <ServiceHeroSection
          ...
          subtitle="Votre site vitrine est la pierre angulaire de votre présence digitale au Maroc. Nous concevons des sites web esthétiques, professionnels et optimisés pour convertir vos visiteurs en clients fidèles."
          backgroundImageUrl="/images/service-hero-sites-vitrines-dark.png"
        />
        ...
        <ServiceFeaturesSection
          ...
          features={[
            {
              icon: "Palette",
              name: "Design Personnalisé et Unique",
              description:
        ...
        <ShowcaseSection
          ...
          images={[
            {
              src: "/images/showcase-sites-vitrines-1-dark.png",
              alt: "Mockup site vitrine moderne pour agence digitale",
            },
            {
              src: "/images/showcase-sites-vitrines-2-dark.png",
              alt: "Mockup site vitrine professionnel pour consultant",
            },
            {
              src: "/images/showcase-sites-vitrines-3-dark.png",
